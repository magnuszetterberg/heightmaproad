...
public class PrometeoEditor : Editor{
  ...
  //
  //
  private SerializedProperty torqueMultiplier;
  ...
  private void OnEnable(){
    ...
    torqueMultiplier = SO.FindProperty("torqueMultiplier");
  ...
  public override void OnInspectorGUI(){
    ...
    //
    //
    torqueMultiplier.intValue = EditorGUILayout.IntSlider("Torque Multiplier:", torqueMultiplier.intValue, 1, 100);
